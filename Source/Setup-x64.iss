...
DefaultDirName={pf64}\SQLCE Query Analyzer
...
[Icons]
Name: "{commondesktop}\SQL Compact Query Analyzer (64-bit)"; Filename: "{app}\{#MyAppExeName}"; WorkingDir: "{app}"; IconFilename: "{app}\{#MyAppIcon}"; Tasks: DesktopIcon
